...
<template>
  <div
    class="h-10 px-3 gap-1 sm:h-14 sm:px-4 sm:gap-2 min-w-min rounded-sm flex justify-center items-center uppercase text-white font-bold cursor-pointer select-none"
